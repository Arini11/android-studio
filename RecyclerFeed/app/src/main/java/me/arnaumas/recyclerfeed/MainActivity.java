package me.arnaumas.recyclerfeed;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void getInstagramData() {
        ...
        String url = "https://v1.nocodeapi.com/arnaumas/instagram/fRxfVqOUBWGxvEtl";
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < dataArray.length(); i++) {
                        ...
                        String permalink = "http://i.imgur.com/DvpvklR.png";
                        System.out.println("PERMALINK -----> "+permalink);
                        ...
                        System.out.println("OBJECTE  ----> " + instaModal.getPermalink());
